...
def collect_data(data, message_count):
    try:
        ...
        if (len(temperature_data) < 20):
            ...
            aqi_index.append(int(decode['AQI']))
        else:
            ...
            payload = {"timestamp": str(timenow), "temperature": temperature, "humidity": humidity, "gas_sensor": gas_value, "dust_sensor": dust_value, "AQI": aqi_value}
